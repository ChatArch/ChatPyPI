...
预期过程和结果：
  ...
  2. 预期额外生成 `DEVELOP.md`、`CHANGELOG.md`、`AGENTS.md`、`README.en.md`、`mkdocs.yml`、`src/<module>/cli.py`、`docs/index.md`、`docs/index.en.md`、`docs/commands.md`、`docs/commands.en.md`、`docs/capability-map.md`、`docs/capability-map.en.md`、`docs/interface-tree.md`、`tests/cli-tests/README.md`、`tests/mock-cli-tests/README.md`、`tests/code-tests/README.md`；默认不生成 `docs/development-plan.md`、`docs/cli-tree.md` 或 `docs/CNAME`。
  ...
  6. 这些文件应体现 CLI 规范、开发规范、文档/测试约定、MkDocs i18n 语言切换、首页非线性导航、命令地图、能力地图、PR preview 和自动化基础说明。
  7. 可通过 `--without-mkdocs` 跳过 mkdocs/docs 文件，通过 `--without-workflows` 跳过 `.github/workflows/`；可用 `--docs-domain` 调整文档域名，用 `--with-docs-cname` 显式生成 `docs/CNAME`。
